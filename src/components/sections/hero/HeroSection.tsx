...
export const HeroSection = () => {
    return (
        <SectionProvider
            paddingY="none"
            className="pt-6 sm:pt-8 md:pt-10 lg:pt-12 pb-20 md:pb-32 mb-16 relative z-20"
        >
                ...
                <div className="w-full md:w-1/2 text-center md:text-left pt-4">
                    ...
                    >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="Ziyad Tber on GitHub"
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="Ziyad Tber on LinkedIn"
                            ...
                            title="LinkedIn"
                        >
                            <svg aria-hidden="true" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" /></svg>
                        </a>
                        {/* Gmail */}
                        <a
                            href="mailto:tberziad016@gmail.com"
                            aria-label="Email Ziyad Tber"
                            ...
                            title="Email"
                        >
                            <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5"><rect width="20" height="16" x="2" y="4" rx="2" /><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" /></svg>
                        </a>
                        {/* WhatsApp */}
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="Contact Ziyad Tber on WhatsApp"
